...
namespace ProyectoCsharp.Controllers
{
    ...
    public async Task<IActionResult> Create([Bind("StartDate,EndDate,LeaveTypeId,DateRequest,RequestComments,Approved,Cancelled,RequestingEmployeeId,Id,DateCreated,DateModified")] LeaveRequest leaveRequest)
    {
